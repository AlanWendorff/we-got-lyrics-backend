...
export declare class HLTVFactory {
    ...
    getMatches: ({ eventID, eventType, filter }?: {
        eventID?: number | undefined;
        eventType?: MatchEventType | undefined;
        filter?: import("./enums/MatchFilter").MatchFilter | undefined;
    }) => Promise<(import("./models/UpcomingMatch").UpcomingMatch | import("./models/LiveMatch").LiveMatch)[]>;
    getMatchesStats: ({ startDate, endDate, matchType, maps, rankingFilter }?: {
...
export { hltvInstance as HLTV, MapSlug, Map, MatchType, RankingFilter, StreamCategory, ThreadCategory, WinType, EventSize, ContentFilter, BestOfFilter, MatchEventType };
