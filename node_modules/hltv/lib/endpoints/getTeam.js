...
var getTeam = function (config) { return function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var t$, e$, name, logo, coverImage, location, facebook, twitter, instagram, rank, players, recentResults, rankingDevelopment, rankings, bigAchievements, events;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    e$ = _b.sent();
                    checkForRateLimiting_1.checkForRateLimiting(t$);
                    checkForRateLimiting_1.checkForRateLimiting(e$);
                    ...
                    instagram = t$('.instagram').parent().attr('href');
